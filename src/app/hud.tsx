...
import AoTickerHud from './ticker-hud'
...
@observer
class MainMenu extends React.PureComponent<Props, State> {
  constructor(props) {
    super(props)
    this.state = { theme: 1 }
  }
  ...
  onLogout = () => {
    api.logout()
    console.log('logged out', this.props.aoStore.state.loggedIn)
  }
...
@observer
class AoHud extends React.Component<{}, undefined> {
...
export default withUseStore(AoHud)