...
@observer
class AoBarkMenu extends React.PureComponent<CardMenuProps> {
  constructor(props) {
    super(props)
  ...
  @computed get senpai() {
    const senpai = isSenpai(this.props.aoStore, this.props.memberId)
    switch (senpai) {
      case 1:
        return 'senpai'
      case -1:
  ...
  @computed get renderBarkMenu() {
    ...
    } else if (this.props.aoStore.member.active >= 1) {
      membershipActivator = (
...
export default withUseStore(AoBarkMenu)
