...
@observer
class AoCompleted extends React.PureComponent<CompletedProps> {
	...
	render() {
		...
		const archiveCheckmark = (move: CardPlay) => {
			...
			const nameFrom = this.props.aoStore.hashMap.get(move.from.taskId).name
...
export default withUseStore(AoCompleted)
